...
const recordBoreFont = fetch(
  "https://cdn.jsdelivr.net/npm/@fontsource/libre-baskerville@5.2.6/files/libre-baskerville-latin-400-normal.woff",
)
...
async function renderRecordBore(faceUrl: string): Promise<ImageResponse> {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* eslint-disable-next-line @next/next/no-img-element -- ImageResponse needs a plain image element */}
        <img
          src={faceUrl}
          alt=""
          width="252"
    ...
    ),
    {
      ...
      height: 630,
      fonts: font
        ? [{ name: "Libre Baskerville", data: font, style: "normal", weight: 400 }]
        : undefined,
    },
  );
}
