...
const QUESTIONS: Q[] = [
  ...
  { group: "taste", q: "What is the minimum alcohol for Brunello di Montalcino, and how does the disciplinare describe the wine?", must: ["12.5|12,5|twelve and a half", "ruby|rubino|garnet|granato"], truth: "12.50% vol; colore rosso rubino intenso tendente al granato; sapore asciutto, caldo, un po' tannico, robusto, armonico, persistente." },
